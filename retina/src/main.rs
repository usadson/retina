...
fn main() {
    if cfg!(debug_assertions) {
        env_logger::Builder::from_env(env_logger::Env::default().default_filter_or("warn,retina,retina_common,retina_compositor=info,retina_dom,retina_gfx,retina_gfx::font,retina_layout,retina_page,retina_platform_object,retina_scrittura,retina_style,retina_style_computation,retina_style_parser,retina_user_agent"))
